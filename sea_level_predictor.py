...
def draw_plot():
    ...
    # Create first line of best fit
        x_val = np.arange(df['Year'].min(), 2051, 1)
        sloper, intercept, r, p, std_err = linregress(x = df.Year, y = (df['CSIRO Adjusted Sea Level']))
        plt.plot(x_val,(sloper * x_val + intercept), linestyle = '--', c = 'black')
    ...
    # Create second line of best fit
        ...
        x_val_2000 = np.arange(2000, 2051, 1)
        plt.plot(x_val_2000,(x_val_2000*slope2+intercept2), linestyle = ':', c='red')
